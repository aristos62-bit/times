...
/// `migration_v1_to_v2.dart`) και στο `beforeOpen` ενεργοποιείται το
...
class AppDatabase extends _$AppDatabase {
  ...
  MigrationStrategy get migration => MigrationStrategy(
        ...
        // v1 → v2 (25-09-2026): data-only καθαρισμός Γραμμάριο/
        // Χιλιοστόλιτρο — ΚΑΜΙΑ αλλαγή σχήματος (βλ. migration_v1_to_v2).
