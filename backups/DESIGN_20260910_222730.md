...
Δεν δημιουργήθηκε `injection/` — η DI έρχεται μαζί με το πρώτο consumer (Phase 3).
ReceiptRepository αναβάλλεται πλήρως στο Phase 3 (μαζί με ReceiptDao + §5.1.4/§5.1.5).
...
4. **Repositories**
   ...
   **Review & διορθώσεις 2026-09-10 (Step 4.1):** υλοποιήθηκε Route A-Συνεπές —
   ...
   ανά feature έρχεται με τα Phase 3–6. Injetcion/ αναβάλλεται για Phase 3+.
