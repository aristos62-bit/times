...
abstract final class AppMessages {
  ...
  /// `restoreSuccess`).
  static const String backupCreated = 'Το αντίγραφο δημιουργήθηκε';

  /// Confirm επαναφοράς με ρητή προειδοποίηση αντικατάστασης + σημείωση
  /// auto-backup (§2.3 · Βήμα 5 — κλειδωμένη σειρά Δ).
