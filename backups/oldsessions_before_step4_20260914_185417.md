...
- **Επόμενα βήματα:** Φάση 0, Βήμα 4 υπόλοιπα SPoT — `app_exceptions.dart` (mapping σε app_errors, θα χρησιμοποιήσει το `LogTag` από το debug_config) → `app_enums.dart`, `app_theme.dart`, `app_colors.dart`, `app_routes.dart`.
