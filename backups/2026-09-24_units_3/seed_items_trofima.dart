...
const List<ItemSeed> seedItemsTrofima = <ItemSeed>[
  ...
  (name: 'Βούτυρο αγελαδινό', subCategoryName: 'Γαλακτοκομικά & Ψυγείου', defaultUnitName: 'Γραμμάριο'),
  ...
  (name: 'Μέλι ανθέων', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),
  (name: 'Μέλι δασόμελο', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),
  (name: 'Μέλι πευκόμελο', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),
  (name: 'Φυστικοβούτυρο', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Τεμάχιο'),
  (name: 'Μερέντα', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),
  (name: 'Άλειμμα σοκολάτας', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),
  (name: 'Ταχίνι', subCategoryName: 'Μαρμελάδες, Μέλια & Αλείμματα', defaultUnitName: 'Γραμμάριο'),

  // ── Μπαχαρικά & Αλάτι (10) ──────────────────────────────────────────────
  (name: 'Αλάτι κλασικό', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Αλάτι θαλασσινό', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Πιπέρι μαύρο', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Πάπρικα γλυκιά', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Κανέλα', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Ρίγανη', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Μπαχάρι', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Μείγμα κάρι', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Ζάχαρη λευκή', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
  (name: 'Ζάχαρη καστανή', subCategoryName: 'Μπαχαρικά & Αλάτι', defaultUnitName: 'Γραμμάριο'),
