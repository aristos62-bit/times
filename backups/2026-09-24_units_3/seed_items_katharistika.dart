...
const List<ItemSeed> seedItemsKatharistika = <ItemSeed>[
  ...
  (name: 'Απορρυπαντικό υγρό', subCategoryName: 'Απορρυπαντικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  ...
  // ── Μαλακτικά Ρούχων (10) ───────────────────────────────────────────────
  (name: 'Μαλακτικό κλασικό', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό με λεβάντα', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό με φρέσκο αέρα', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό υγρό', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό κάψουλες', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Τεμάχιο'),
  (name: 'Μαλακτικό concentrated', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό για ευαίσθητα', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό 3 σε 1', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό με άρωμα', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Μαλακτικό βιολογικό', subCategoryName: 'Μαλακτικά Ρούχων', defaultUnitName: 'Χιλιοστόλιτρο'),

  // ── Υγρά Πιάτων (10) ────────────────────────────────────────────────────
  (name: 'Υγρό πιάτων κλασικό', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Υγρό πιάτων με λεμόνι', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Υγρό πιάτων concentrated', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Υγρό πιάτων για ευαίσθητα χέρια', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Υγρό πιάτων αντιβακτηριδιακό', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Υγρό πιάτων βιολογικό', subCategoryName: 'Υγρά Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  ...
  (name: 'Καθαριστικό spray γενικής χρήσης', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για γυαλί', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για ανοξείδωτο', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για ξύλο', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για μπάνιο', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για κουζίνα', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για πάτωμα', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray για χαλιά', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray με ξίδι', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό spray με λεμόνι', subCategoryName: 'Καθαριστικά Γενικής Χρήσης', defaultUnitName: 'Χιλιοστόλιτρο'),

  // ── Καθαριστικά Μπάνιου (10) ────────────────────────────────────────────
  (name: 'Καθαριστικό WC gel', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό WC σε σκόνη', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Τεμάχιο'),
  (name: 'Καθαριστικό WC με λεβάντα', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Αποσμητικό WC', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Τεμάχιο'),
  (name: 'Καθαριστικό μπανιέρας', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό πλακιδίων', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό νιπτήρα', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Καθαριστικό καθρέφτη', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Απολυμαντικό μπάνιου', subCategoryName: 'Καθαριστικά Μπάνιου', defaultUnitName: 'Χιλιοστόλιτρο'),
  ...
  (name: 'Υγρό πλυντηρίου πιάτων', subCategoryName: 'Καθαριστικά Πλυντηρίου Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
  (name: 'Αλάτι πλυντηρίου πιάτων', subCategoryName: 'Καθαριστικά Πλυντηρίου Πιάτων', defaultUnitName: 'Γραμμάριο'),
  (name: 'Λαμπρυντικό πλυντηρίου πιάτων', subCategoryName: 'Καθαριστικά Πλυντηρίου Πιάτων', defaultUnitName: 'Χιλιοστόλιτρο'),
