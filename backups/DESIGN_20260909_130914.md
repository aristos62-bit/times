...
class ReceiptDao extends DatabaseAccessor<AppDatabase> with _$ReceiptDaoMixin {
  ...
  Future<void> _updateReceiptTotals(int receiptId) async {
    ...
    await (update(receipts)..where((r) => r.id.equals(receiptId)))
        .write(ReceiptsCompanion(
          ...
          vatTotal: Value(vat),
          remainingAmount: Value(total - await _getPaidAmount(receiptId)),
          updatedAt: Value(DateTime.now()),
        ));
  }
  ...
  Future<void> _updatePaymentStatus(int receiptId) async {
    ...
    final remaining = receipt.totalAmount - paidAmount;
...
class BudgetDao extends DatabaseAccessor<AppDatabase> with _$BudgetDaoMixin {
  ...
  /// ΕΝΙΑΙΟ query: LEFT JOIN budgets με receipt_items/receipts/items.
  ...
  Stream<BudgetWithSpent> watchBudget(int categoryId, int month, int year) {
    ...
    final query = customSelect(
      ...
      'FROM budgets b '
      'LEFT JOIN receipt_items ri ON 1=1 '
