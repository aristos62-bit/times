...
abstract final class AppStrings {
  ...
  // ─── Template counter (ΠΡΟΣΩΡΙΝΟ — αφαιρείται στη Φάση 3) ─────────────────
  /// Κείμενο σώματος / tooltip του προσωρινού default counter.
  static const String counterInstruction = 'Πατήσατε το κουμπί τόσες φορές:';
  static const String counterIncrementTooltip = 'Αύξηση';
}