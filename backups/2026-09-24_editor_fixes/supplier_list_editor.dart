...
class SupplierListEditor extends ConsumerWidget {
  ...
  /// Κουμπί διαγραφής με πύλη (§2.3:275, πατρόν Βήματος 4): καθαρός → ενεργό·
  /// μπλοκαρισμένος → greyed + tooltip με πλήθος αποδείξεων· loading/error
  /// πύλης → ανενεργό (+tap retry σε error).
  Widget _deleteGate({
    ...
    return IconButton(
      ...
      tooltip: ok == false && count != null
          ? AppMessages.supplierReceiptsTooltip(count)
      ...
      trailing: Row(
        ...
        children: [
          ...
          _deleteGate(
            ...
            inUse: ref.watch(receiptCountSupplierProvider(supplier.id)),
