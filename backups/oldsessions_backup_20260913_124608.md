...
- **Φάση που βρισκόμαστε:** Φάση 0 — Βήμα 2 (Branding) ΟΛΟΚΛΗΡΩΘΗΚΕ · Εκκρεμεί μόνο το τελικό build verification.
- **Επόμενο βήμα:** Φάση 0, Βήμα 3 — Δημιουργία δομής φακέλων `lib/` (§1.2 του DESIGN.md) με κενά αρχεία-σκελετούς.
- **Σημείωση:** Το `DESIGN.md` ζει στον φάκελο `Desktop` (όχι μέσα στο project). Τα backups όλων των σημάτων βρίσκονται στο `backups/`.