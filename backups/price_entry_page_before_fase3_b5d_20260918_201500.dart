...
/// Watch-άρει ΜΟΝΟ τοπικούς controllers (`receiptFormControllerProvider` για
/// το header, `itemSearchControllerProvider` για το επιλεγμένο είδος) —
/// καμία εξάρτηση από repository → η βάση παραμένει κλειστή όσο δεν υπάρχει
