...
class SupplierManagementController extends Notifier<SettingsState> {
  ...
  /// Μετονομάζει προμηθευτή. Ακριβώς ίδιο κείμενο → no-op επιτυχία
  /// (χωρίς write)· αλλαγή μόνο πεζών/τόνων ΓΡΑΦΕΤΑΙ (24-09-2026).
  /// Dup προς άλλον (εξαιρείται ο εαυτός) → `nameExists`. Ανύπαρκτο id →
