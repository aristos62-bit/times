...
class _ReceiptFormState extends State<ReceiptForm> {
  ...
  Widget build(BuildContext context) {
    // shrinkWrap + NeverScrollable: η φόρμα ζει ΜΕΣΑ στο scrollable του
    // entry screen (φωλιασμένο ListView → unbounded height error αλλιώς).
    // Standalone (Scaffold body, bounded) συμπεριφέρεται όπως πριν — ίδιο
    // pattern με το ReceiptItemList.
    return ListView(
      shrinkWrap: true,
