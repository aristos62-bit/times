...
void main() {
  group('AppMessages', () {
    ...
    test('backupCreated = «Το αντίγραφο δημιουργήθηκε» (§2.3 · Βήμα 5)', () {
      expect(AppMessages.backupCreated, 'Το αντίγραφο δημιουργήθηκε');
    });

    test('restoreConfirmWithBackup — προειδοποίηση + auto-backup (§2.3)', () {
      expect(
